...
public class ClockVolumePreference extends DialogPreference implements View.OnKeyListener {

    private static final String TAG = "WorldClock.ClockVolumePreference";
    ...
    public ClockVolumePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mStreamType = RingtoneManager.TYPE_ALARM;
        setDialogLayoutResource(R.layout.specific_seekbar_dialog);
    }
