...
public class SecSimFragment extends PagerBaseFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if(mContext != null) {
            ...
            int simIndex = Util.SECOND_SIM_NO;
            //util = new Util(getContext(), 2);
...
//                             sr2 = this.getResources().getString(R.string.data_residue_2);
                        ...
                        Log.d("Test:", "progress = " + progress + "usedData =" + usedData + "packageData =" + packageData);
                        Message msg = uiHandler.obtainMessage(0,0,0);
                        Bundle bundle = new Bundle();
                        bundle.putString("traffic",traffic);
                        bundle.putString("GMKB",GMKB);
